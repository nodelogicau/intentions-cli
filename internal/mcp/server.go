...
func (s *Server) instructions() string {
	...
	b.WriteString("Tool names are this implementation's (the Intentions Format names none): intention_*, availability_*, generate, resolve, select, check, acknowledge, bounds, validate, workspace_status. Every result equals the corresponding CLI verb's --json output.\n")
	b.Write(skill.Body())
