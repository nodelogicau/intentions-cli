...
func (s *Server) instructions() string {
	...
	b.WriteString("Tool names are the Intentions Format's Reference Tool Set (README, Reference Tool Set), exposed here as listed: intention_*, availability_*, commitment_*, generate, resolve, select, unresolved, check, acknowledge, bounds, validate, workspace_status. Every result equals the corresponding CLI verb's --json output.\n")
	b.Write(skill.Body())
